...
pub async fn store_design_system(pool: &DbPool, design: &DesignSystem) -> Result<()> {
...
pub async fn get_design_system(pool: &DbPool, project_id: &str) -> Result<Option<DesignSystem>> {
...
pub async fn list_design_systems(pool: &DbPool, project_id: &str) -> Result<Vec<DesignSystem>> {
